...
export class DsPostoTrabalho extends DataSource<PostoTrabalho> {
  _filterChange = new BehaviorSubject( {id: '', descricao: ''} );

  public onChange: EventEmitter<boolean> = new EventEmitter<boolean>();

  get filter(): PostoTrabalhoFilter {
    return this._filterChange.value;
  }

  set filter(filter: PostoTrabalhoFilter) {
  ...
  connect(): Observable<PostoTrabalho[]> {
    ...
    .switchMap(() => {
      ...
      return this._postotrabalhoService.getPostoTrabalhos(this._tokenManager.retrieve(),
