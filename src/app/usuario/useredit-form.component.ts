...
@Component({
  ...
  templateUrl: './useredit-form.component.html',
  styleUrls: ['./useredit-form.component.css']
})
export class UserEditFormComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  set inativo(inativo: boolean) {
    this.user.inativo = booleanToStrSN(inativo);
  }
  get inativo(): boolean {
    return strToBoolean(this.user.inativo);
  }
    ...
    this._route.params.forEach((params: Params) => {
      ...
      if (id) {
        this._userService
          ...
          .retry(3)
          .subscribe(dt => {
            Object.assign(this.user, dt.json());
            // this.user = dt.json();
            this.user.password = '';
            Object.assign(this.user_ant, dt.json());
            // this.user_ant = dt.json();
            this.user_ant.password = '';
            // console.log(1);
        ...
        this._userService
          ...
          .subscribe(
            data => {
              ...
              Object.assign(this.user_ant, data);
              // this.user = data;
              // this.user_ant = data;
  ...
  canDeactivate(): Observable<boolean> | boolean {
    ...
    //   return true;
    // }
    if (this.user.equals(this.user_ant)) {
      return true;
    }
