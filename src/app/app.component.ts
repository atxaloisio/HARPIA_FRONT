...
import { SincronizarComponent } from './utilitario/sincronizar.component';
...
export class AppComponent implements OnInit {
  ...
  //     'cadastros_funcao',
  //     JSON.stringify({
  //       cadastros_funcao: strToBoolean(this.perfil.cadastros_funcao)
  //     })
  //   );
  //   sessionStorage.setItem(
  //     'cadastros_cliente',
  ...
  //   );
  //   sessionStorage.setItem(
  //     'cadastros_posto_trabalho',
  //     JSON.stringify({
  //       cadastros_posto_trabalho: strToBoolean(this.perfil.cadastros_posto_trabalho)
  //     })
  //   );
  //   sessionStorage.setItem(
  //     'cadastros_posto_trabalho_cliente',
  //     JSON.stringify({
  //       cadastros_posto_trabalho_cliente: strToBoolean(
  //         this.perfil.cadastros_posto_trabalho_cliente
  //       )
  //     })
  //   );
  //   sessionStorage.setItem(
  //     'cadastros_posto_trabalho_fornecedor',
  //     JSON.stringify({
  //       cadastros_posto_trabalho_fornecedor: strToBoolean(
  //         this.perfil.cadastros_posto_trabalho_fornecedor
  //       )
  //     })
  //   );
  //   sessionStorage.setItem(
  ...
  //     'aclcontrol_usuario',
  //     JSON.stringify({
  //       aclcontrol_usuario: strToBoolean(
  //         this.perfil.aclcontrol_usuario
  //       )
  //     })
  //   );
  // }
  ...
  //   );
  //   p.cadastros_funcao = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_funcao')).cadastros_funcao
  //   );
  //   p.cadastros_centro_custo = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_centro_custo')).cadastros_centro_custo
  //   );
  //   p.cadastros_posto_trabalho = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_posto_trabalho'))
  //       .cadastros_posto_trabalho
  //   );
  //   p.cadastros_posto_trabalho_cliente = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_posto_trabalho_cliente'))
  //       .cadastros_posto_trabalho_cliente
  //   );
  //   p.cadastros_posto_trabalho_fornecedor = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_posto_trabalho_fornecedor'))
  //       .cadastros_posto_trabalho_fornecedor
  //   );
  ...
  //       .relatorios_protocolo_entrega
  //   );
  //   p.aclcontrol_usuario = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('aclcontrol_usuario'))
  //       .aclcontrol_usuario
  //   );
  ...
  openSincronizar(): void {
    if (strToBoolean(this.perfil.utilitarios_sincronizar)) {
      const dialogResetRef = this.modal.open(SincronizarComponent, {
        width: '400px',
        height: '250px',
        disableClose: true,
        data: {}
